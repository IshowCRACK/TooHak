...
describe('PlayerQuestionInfo', () => {
  ...
  let questionId: QuizQuestionCreate;
  ...
  beforeEach(() => {
    ...
    questionId = createQuizQuestionHandlerV2(quizId, userJwt, defaultQuestionBody) as QuizQuestionCreate;
...
describe('Successful', () => {
  ...
  test('Success', () => {
    updateQuizSessionStateHandler(quizId, sessionId.sessionId, userJwt, 'NEXT_QUESTION');
    expect(playerQuestionInfoHelper(playerId.playerId, 0)).toEqual(
      {
